    ...
    <AuthBase title="Bem vindo de volta!" description="Para continuar conectado conosco, faça login com suas informações pessoais.">
        ...
        <Form method="post" :action="route('login')" :reset-on-success="['password']" v-slot="{ errors, processing }" class="flex flex-col gap-6">
            <div class="grid gap-6">
                <div class="relative">
                    ...
                    <Input
                        ...
                        :class="[errors.email ? 'border border-red-500 focus:border-primary' : 'border border-input focus:border-primary']"
                    />
                    <label
                        for="email"
                ...
                <div class="relative">
                    ...
                    <Input
                        ...
                        placeholder=" "
                        class="peer bg-input/30 pl-10"
                        :class="[errors.password ? 'border border-red-500 focus:border-primary' : 'border border-input focus:border-primary']"
                    />
                    <label
                        for="password"
                        class="absolute top-1/2 left-10 -translate-y-1/2 bg-background text-sm text-muted-foreground transition-all peer-not-placeholder-shown:top-0 peer-not-placeholder-shown:text-xs peer-not-placeholder-shown:text-foreground peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-sm peer-placeholder-shown:text-muted-foreground peer-focus:top-0 peer-focus:text-xs peer-focus:text-primary hover:cursor-text"
            ...
            <div class="text-center text-sm text-muted-foreground">
                Não tem uma conta?
                <TextLink :href="route('register')" class="underline underline-offset-4 hover:text-primary" :tabindex="6"> Criar conta </TextLink>
            </div>
        </Form>
